"""
    This stub is a tester to experiment with Tensorflow and troubleshoot some problems that were
    occuring on my local machine
"""
...
def build_q_learning_network(number_states, number_actions):
    model = tf.keras.models.Sequential([
        tf.keras.layers.Dense(32, activation='relu', input_shape=(number_states,)),
